...
export default function ICantSleep() {
  return (
    <main className={styles.main}>
      <section className={styles.hero}>
        <Image
          src="/home/i-cant-sleep-banner1.png"
          alt="Sleeping Banner"
          layout="fill"
          objectFit="cover"
          quality={100}
      ...
      <section className={styles.infoSection}>
        <div className={styles.sectionHeader}>
          <div>
            <h1 className={overlock.className}>I Can't Sleep</h1>
            <br />
            <p>
              Dissatisfying sleep can be troubling and difficult to treat
              without proper help. How you sleep can impact almost every aspect
              of your health. Prana Health offers comprehensive evaluation and
              treatment to improve quality of sleep.
            </p>
            <br />
            <h2
              className={`${overlock.className}`}
              style={{ lineHeight: "1.5", color: "#92239f", fontSize: "2rem" }}
            >
            ...
            <p>
              ...
              be affected if you have a breathing related sleep disorder, while
              the neurological system is affected if you have a movement related
              sleep disorder.
            </p>
          </div>
          <div className={styles.imageSide}>
            <Image
              src="/home/cannot-sleep-card.png"
              alt="Sleep"
              width={450}
              height={660}
